...
def test_git_pull_fail(mock_execute):
    # Given
    ...
    # When
    actual_response = Git(FakeContentManager("/bin")).pull("test_curr_path").result()
...
@patch("os.environ", {"TEST": "test"})
def test_git_pull_with_auth_fail(mock_execute_with_authentication):
    # Given
    ...
    actual_response = (
        Git(FakeContentManager("/bin")).pull("test_curr_path", auth).result()
    )
...
@patch("jupyterlab_git.git.execute")
@patch("os.environ", {"TEST": "test"})
def test_git_pull_success(mock_execute):
    # Given
...
@patch("jupyterlab_git.git.execute_with_authentication")
@patch("os.environ", {"TEST": "test"})
def test_git_pull_with_auth_success(mock_execute_with_authentication):
    # Given
    mock_execute_with_authentication.return_value = tornado.gen.maybe_future(
        (0, "output")
    )
...
@patch("jupyterlab_git.git.execute")
@patch("os.environ", {"TEST": "test"})
def test_git_push_fail(mock_execute):
    # Given
    mock_execute.return_value = tornado.gen.maybe_future(
        (1, "output", "Authentication failed")
    )
    ...
    actual_response = (
        ...
        .push("test_origin", "HEAD:test_master", "test_curr_path")
        .result()
    )
...
@patch("jupyterlab_git.git.execute_with_authentication")
@patch("os.environ", {"TEST": "test"})
def test_git_push_with_auth_fail(mock_execute_with_authentication):
    # Given
    mock_execute_with_authentication.return_value = tornado.gen.maybe_future(
        (
            1,
    ...
    actual_response = (
        Git(FakeContentManager("/bin"))
        .push("test_origin", "HEAD:test_master", "test_curr_path", auth)
        .result()
    )
...
@patch("jupyterlab_git.git.execute")
@patch("os.environ", {"TEST": "test"})
def test_git_push_success(mock_execute):
    # Given
    mock_execute.return_value = tornado.gen.maybe_future(
    ...
    actual_response = (
        Git(FakeContentManager("/bin"))
        .push(".", "HEAD:test_master", "test_curr_path")
        .result()
    )
...
@patch("jupyterlab_git.git.execute_with_authentication")
@patch("os.environ", {"TEST": "test"})
def test_git_push_with_auth_success(mock_execute_with_authentication):
    # Given
    mock_execute_with_authentication.return_value = tornado.gen.maybe_future(
        (0, "does not matter")
    )
    ...
    actual_response = (
        Git(FakeContentManager("/bin"))
        .push(".", "HEAD:test_master", "test_curr_path", auth)
        .result()
    )
