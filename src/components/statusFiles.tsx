      ...
      <div>
        ...
        <div className= 'jp-Git-section-fileContainer'>
          <div className='jp-Git-untracked' >
              ...
              <button className={this.state.untracked_show?`jp-Git-button ${JP_IMAGE_CARET_DOWN}`:`jp-Git-button ${JP_IMAGE_CARET_RIGHT}`} onClick={()=>this.dropdown_untracked()}></button>
